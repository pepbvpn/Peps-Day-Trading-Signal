...
st.title("🚀 Real Day Trading Signal Dashboard (MACD, EMA, VWAP, Volume)")
...
fig.update_layout(title=f"{ticker} Price + VWAP + Signals", xaxis_title="Time", yaxis_title="Price", height=600)
